...
export const appConfig: ApplicationConfig = {
  providers: [provideRouter(routes), provideStore({ authState: authReducer }), provideEffects(authEffects), provideHttpClient(withInterceptorsFromDi()), tokenInterceptor, provideStoreDevtools({
